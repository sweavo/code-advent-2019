...
def day5part2():
    ...
    7873292
    """
    return next(Intputer( DAY5_TAPE, [5]))
...
def day9part1():
    ...
    [2406950601]
    """
    return list( Intputer( DAY9_TAPE, [1] ) )
...
def day9part2():
    ...
    83239
    """
    return next( Intputer( DAY9_TAPE, [2] ) )
